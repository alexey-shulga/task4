...
export const SendMessages = () => {
  ...
  const fetchMessages = useCallback(async() => {
    try {
      const fetched = await request('/api/messages/sendmessages', 'GET', null, {
    ...
    return (
        <div>
          ...
          <div className='buttons'>
            <ButtonGroup aria-label="Basic example">
              <Button variant="outline-secondary" onClick={messagesHandler}>Incoming messages</Button>
              <Button variant="success">Sent messages</Button>
            </ButtonGroup>
          </div>
